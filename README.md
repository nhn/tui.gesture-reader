...
## 🎨 Features
* Distinguishes each gesture type(`flick`, `longtab`, `dblclick`).
...
This component does not require the container.
You can distinguish the gesture with this component in the callback when an event occurs on the target element.
...
This software is licensed under the [MIT](https://github.com/nhnent/tui.gesture-reader/blob/production/LICENSE) © [NHN Entertainment](https://github.com/nhnent).
